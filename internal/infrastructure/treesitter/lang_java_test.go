...
`,
			...
			wantImports: 1,
			// field_declaration type (Status) + field_access (Status.ACTIVE) = 2
			wantCalls:   2,
			wantBreadth: 2, // Status + ACTIVE
		},
		{
...
`,
			...
			purl:        "pkg:maven/java/jdk@17",
			wantImports: 1,
			// field_declaration type (Locale) + field_access (Locale.US) = 2
			wantCalls:   2,
...
`,
			...
			purl:        "pkg:maven/com.google.code.gson/gson@2.10",
			wantImports: 1,
			// field_declaration type (Gson) + new Gson() = 2
			wantCalls:   2,
			wantBreadth: 1, // Gson
		},
	}
...
`,
			...
			purl:        "pkg:maven/com.google.code.gson/gson@2.10",
			wantImports: 1,
			// field_declaration type (JsonElement) + cast (JsonElement) = 2
			wantCalls:   2,
			wantBreadth: 1, // JsonElement
		},
		{
