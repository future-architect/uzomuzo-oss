...
- **Use Case-Insensitive Comparison for URL Host Detection**: When detecting hosts in URLs (e.g., `github.com`), use case-insensitive comparison per RFC — user input and API data may use mixed case.
