...
| **Review Needed** | Insufficient data for automated classification, or the registry has yanked every release, so nothing is installable from that registry | Manual investigation required |
...
- **Claude Code skills**: LLM-powered analysis prompts for EOL risk assessment and dependency removal prioritization — [details](claude-skills/)
