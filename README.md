...
| **Review Needed** | Insufficient data for automated classification, or the registry has yanked every release so nothing is installable | Manual investigation required |
