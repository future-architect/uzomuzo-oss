...
- **Instructions**: Edit `.github/instructions/`. Run `make sync-instructions` to regenerate `.claude/rules/` (except the hand-maintained `instruction-sync.md`) and `AGENTS.md`.
